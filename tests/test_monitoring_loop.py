...
# Regression: SPOTIFY_SUFFIX is part of the playlist's own identity - ALT_VIEW's console line must
# embed it inside the brackets ("[Playlist Name (by Spotify)]"), not append it after them
# ("[Playlist Name] (by Spotify)"), which reads as if it were a separate trailing note.
